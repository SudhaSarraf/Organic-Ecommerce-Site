...
function DisplaySpices() {
    ...
    const [spicesProduct, setSpicesProducts] = useState([]);
    ...
    const fetchAllProducts = async () => {
        try {
            ...
            // Filter products to get only 'spices' category
            const spices = response.data.output.filter(product => product.category === 'spices');
